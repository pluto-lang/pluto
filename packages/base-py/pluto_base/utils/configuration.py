...
def current_project_name():
    return fetch_env_with_throw("PLUTO_PROJECT_NAME")


def current_stack_name():
    return fetch_env_with_throw("PLUTO_STACK_NAME")


def current_platform_type() -> PlatformType:
    val = fetch_env_with_throw("PLUTO_PLATFORM_TYPE")
